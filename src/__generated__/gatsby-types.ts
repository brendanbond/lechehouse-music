...
enum SiteFieldsEnum {
  ...
  siteMetadata___about = 'siteMetadata.about',
  port = 'port',
  host = 'host',
  polyfill = 'polyfill',
...
type HomePageQuery = { readonly aboutHeader: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }>, readonly gearHeader: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }>, readonly discogHeader: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }>, readonly bookingHeader: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }>, readonly videoHeader: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }> };

type BrandQueryVariables = Exact<{ [key: string]: never; }>;


type BrandQuery = { readonly file: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }> };

type BookingQueryVariables = Exact<{ [key: string]: never; }>;
...
type AboutQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'about'>> }>, readonly aboutContent: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }> };

type DiscogQueryVariables = Exact<{ [key: string]: never; }>;


type DiscogQuery = { readonly allFile: { readonly nodes: ReadonlyArray<(
      Pick<File, 'id'>
...
type GearTwoQuery = { readonly gearTwoContent: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }> };
